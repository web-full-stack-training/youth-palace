...
@section('content')
    ...
    <div class="dashboard-body d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="club position-relative">
                ...
                @foreach($club as $data)
                    <div class="collaboration-content d-flex flex-column justify-content-center align-items-center mx-4">
                        ...
                        <div class="description-club">
                            <p> {{ mb_strimwidth($data['description'], 0, 140) . '...' }}</p>
                        </div>
            ...
            <div class="collaboration-button flex-column justify-content-center align-items-center mt-3">
                <a href="{{ route('club.page') }}" class="btn px-2 border border-secondary">Club Page</a>
                <a href="clubs" class="btn px-2 border border-secondary">Admin Club Page</a>
            </div>
        </div>
    </div>
