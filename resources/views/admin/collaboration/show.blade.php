    ...
    <table class="table table-bordered border border-dark">
        ...
        @foreach($collaboration as $data)
            <tr class="tr border">
                ...
                <td>{{ $data['name'] }}</td>
                <td class="edit"><a href="{{ 'collaboration/edit/' . $data['id'] }}"><button class="text-dark border-0"><i class="fal fa-edit"></i></button></a></td>
                <td class="delete"><button class="border-0" ><i class="fas fa-trash"></i></button></td>
            </tr>
        @endforeach
        </tbody>
    </table>
    <a class="btn btn-primary" href="collaboration/create" role="button">Create New</a>
