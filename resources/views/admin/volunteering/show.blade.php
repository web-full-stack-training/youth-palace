...
@section('content')
    ...
    <table class="table table-bordered border border-dark">
        ...
        @foreach($volunteering as $data)
            <tr class="tr border">
                ...
                <td class="edit"><a href="{{ 'volunteering/edit/' . $data['id'] }}"><button class="text-dark border-0"><i class="fal fa-edit"></i></button></a></td>
                <td class="delete"><button class="border-0" ><i class="fas fa-trash"></i></button></td>
            </tr>
        @endforeach
        </tbody>
    </table>
    <a class="btn btn-primary" href="volunteering/create" role="button">Create New</a>
    ...
    <script src="{{ asset('js/volunteering.js') }}"></script>
@endsection
